<?php
  ...
  //pildi üleslaadimise osa
	...
	if(isset($_POST["submitPic"])) {
		...
		if(!empty($_FILES["fileToUpload"]["name"])){
			...
			$targetFileName = "vp_" .$timeStamp ."." .$imageFileType;
			...
			// kui kõik korras, laeme üles
				...
				//lisame ka teksti
				$textToImage = $_SESSION["userFirstName"];
				$textColor = imagecolorallocatealpha($myImage, 255, 255, 255, 60);
				//alpha on 0-127;
				//imagettftext($myImage, 20, -45, 10, 50, $textColor, "../vp_picfiles/ARIALBD.TTF", $textToImage);
				imagettftext($myImage, 20, 0, 10, 35, $textColor, "../vp_picfiles/ARIALBD.TTF", $textToImage);
				...
				if($imageFileType == "jpg" or $imageFileType == "jpeg"){
				  if(imagejpeg($myImage, $target_file, 90)){
					...
					addProfilePicData($targetFileName);
				  } else {
					echo "Pahasti!";
				  }
				}
  ...
  $pageTitle = "Profiilifoto üleslaadimine";
  require("header.php");
?>
	...
	<h2>Profiilifoto üleslaadimine</h2>
